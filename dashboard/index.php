      ...
      <!-- <div style="float: right;" class="bulan">
        <form method="POST" action="" class="form-inline">
          ...
          <select class="form-control mr-2" name="bulan">
            <option value="">-</option>
            <option <?php $arrayBulan[1]="Januari"; ?> value="1">Januari</option>
            <option <?php $arrayBulan[2]="Februari"; ?> value="2">Februari</option>
            <option <?php $arrayBulan[3]="Maret"; ?> value="3">Maret</option>
            <option <?php $arrayBulan[4]="April"; ?> value="4">April</option>
            <option <?php $arrayBulan[5]="Mei"; ?> value="5">Mei</option>
            <option <?php $arrayBulan[6]="Juni"; ?> value="6">Juni</option>
            <option <?php $arrayBulan[7]="Juli"; ?> value="7">Juli</option>
            <option <?php $arrayBulan[8]="Agustus"; ?> value="8">Agustus</option>
            <option <?php $arrayBulan[9]="September"; ?> value="9">September</option>
            <option <?php $arrayBulan[10]="Oktober"; ?> value="10">Oktober</option>
            <option <?php $arrayBulan[11]="November"; ?> value="11">November</option>
            <option <?php $arrayBulan[12]="Desember"; ?> value="12">Desember</option>
          </select>
